...
#ifndef CUSTOM_HID_KEYBOARD_HS_BINTERVAL
#define CUSTOM_HID_KEYBOARD_HS_BINTERVAL                      0x05U
#endif /* CUSTOM_HID_KEYBOARD_HS_BINTERVAL */

#ifndef CUSTOM_HID_KEYBOARD_FS_BINTERVAL
#define CUSTOM_HID_KEYBOARD_FS_BINTERVAL                      0x05U
#endif /* CUSTOM_HID_KEYBOARD_FS_BINTERVAL */

#ifndef USBD_CUSTOMHID_KEYBOARD_OUTREPORT_BUF_SIZE
#define USBD_CUSTOMHID_KEYBOARD_OUTREPORT_BUF_SIZE            16U
#endif /* USBD_CUSTOMHID_KEYBOARD_OUTREPORT_BUF_SIZE */

#ifndef USBD_CUSTOM_HID_KEYBOARD_REPORT_DESC_SIZE
#define USBD_CUSTOM_HID_KEYBOARD_REPORT_DESC_SIZE             164U
#endif /* USBD_CUSTOM_HID_KEYBOARD_REPORT_DESC_SIZE */

#define CUSTOM_HID_KEYBOARD_DESCRIPTOR_TYPE                   0x21U
#define CUSTOM_HID_KEYBOARD_REPORT_DESC                       0x22U

#define CUSTOM_HID_KEYBOARD_REQ_SET_PROTOCOL                  0x0BU
#define CUSTOM_HID_KEYBOARD_REQ_GET_PROTOCOL                  0x03U

#define CUSTOM_HID_KEYBOARD_REQ_SET_IDLE                      0x0AU
#define CUSTOM_HID_KEYBOARD_REQ_GET_IDLE                      0x02U

#define CUSTOM_HID_KEYBOARD_REQ_SET_REPORT                    0x09U
#define CUSTOM_HID_KEYBOARD_REQ_GET_REPORT                    0x01U
/**
  * @}
  */
...
typedef struct
{
  uint8_t  Report_buf[USBD_CUSTOMHID_KEYBOARD_OUTREPORT_BUF_SIZE];
  uint32_t Protocol;
  uint32_t IdleState;
  uint32_t AltSetting;
  uint32_t IsReportAvailable;
  CUSTOM_HID_StateTypeDef state;
} USBD_CUSTOM_HID_Keyboard_HandleTypeDef;
/**
  * @}
  */
...
/** @defgroup USBD_CORE_Exported_Macros
  * @{
  */
#define HID_REPORT_TYPE_INVALID     0
