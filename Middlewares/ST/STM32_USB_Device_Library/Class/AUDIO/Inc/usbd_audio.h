...
#ifndef USBD_MAX_NUM_AUD_INTERFACES
#define USBD_MAX_NUM_AUD_INTERFACES                       1U
#endif /* USBD_AUDIO_FREQ */
...
//#define AUDIO_FS_BINTERVAL                            20
//#define AUDIO_FS_BINTERVAL                            4
#endif /* AUDIO_FS_BINTERVAL */

#define USE_FEATURE_UNIT			1

#define AUDIO_IN_EP                                   0x81U // [EDITED]
#define AUDIO_OUT_EP                                  0x01U

  #if USE_FEATURE_UNIT
#define USB_AUDIO_CONFIG_DESC_SIZ                     109U  // [EDITED] //0x6DU
//#error
  #else
#define USB_AUDIO_CONFIG_DESC_SIZ                     100U  // [EDITED] //0x6DU
#error
  #endif
...
#define AUDIO_OUT_PACKET                              (uint16_t)(((USBD_AUDIO_FREQ * USBD_AUDIO_CHANNEL * 2U) / (1000U/AUDIO_FS_BINTERVAL)))

#define AUDIO_IN_PACKET                               (uint16_t)(((USBD_AUDIO_FREQ * USBD_AUDIO_CHANNEL * 2U) / (1000U/AUDIO_FS_BINTERVAL))) /*(Freq(Samples)*1(CHANNEL)*2(BITSPERSAMPLE))*/
