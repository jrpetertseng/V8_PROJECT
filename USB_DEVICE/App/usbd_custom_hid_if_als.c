...
__ALIGN_BEGIN static uint8_t CUSTOM_HID_ALS_ReportDesc_HS[USBD_CUSTOM_HID_ALS_REPORT_DESC_SIZE] __ALIGN_END =
{
  /* USER CODE BEGIN 1 */
...
static int8_t CUSTOM_HID_ALS_Init_HS(void);
static int8_t CUSTOM_HID_ALS_DeInit_HS(void);
static int8_t CUSTOM_HID_ALS_OutEvent_HS(uint8_t event_idx, uint8_t state);

/**
  * @}
  */

USBD_CUSTOM_HID_ItfTypeDef USBD_CustomHID_ALS_fops_HS =
{
  CUSTOM_HID_ALS_ReportDesc_HS,
  CUSTOM_HID_ALS_Init_HS,
  CUSTOM_HID_ALS_DeInit_HS,
  CUSTOM_HID_ALS_OutEvent_HS
};
...
static int8_t CUSTOM_HID_ALS_OutEvent_HS(uint8_t event_idx, uint8_t state)
{
  ...
  USBD_CUSTOM_HID_ALS_ReceivePacket(&hUsbDeviceHS);
...
int8_t USBD_CUSTOM_HID_ALS_SendReport_HS(uint8_t *report, uint16_t len)
{
   ...
   */
//  USBD_Composite_Switch_Itf(&hUsbDeviceHS, USBD_CUSTOMHID_ALS_INTERFACE);
  return USBD_CUSTOM_HID_ALS_SendReport(&hUsbDeviceHS, report, len);
}
/* USER CODE END 11 */
